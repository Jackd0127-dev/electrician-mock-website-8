...
const NOVAS_PHONE = '07483 260885'
const NOVAS_PHONE_HREF = 'tel:07483260885'
const NOVAS_EMAIL = 'help@novasagency.com'
const NOVAS_ADDRESS = "47 Novas Agency's Road BTNOVA3"
...
const projects: Project[] = [
  ...
  { title: 'Beacon Yard', summary: 'Power distribution, LED lighting and EV-ready infrastructure for a mixed-use workspace.', location: 'Demo · Lisburn', category: 'Commercial fit-out', image: asset('/images/electrician-consumer-unit.jpg') },
  ...
  { title: 'Harbour House', summary: 'A refined apartment renovation with concealed services and considered feature lighting.', location: 'Demo · Holywood', category: 'Residential renovation', image: asset('/images/rooftop-solar-panels.jpg') },
]
...
function Footer() {
  return <footer className="site-footer">
    <div className="footer-main">
      ...
      <div><span className="footer-kicker">Get in touch</span><p><MapPin size={16} /> {NOVAS_ADDRESS}</p><p><Mail size={16} /><a href={`mailto:${NOVAS_EMAIL}`}>{NOVAS_EMAIL}</a></p><p><Phone size={16} /><a href={NOVAS_PHONE_HREF}>{NOVAS_PHONE}</a></p></div>
    </div>
...
function Home() {
  return <>
    <section className="home-hero"><picture className="home-hero-media" aria-hidden="true"><source media="(min-width: 681px)" srcSet={asset('/images/raze-solar-GXLPLG3_Vf4-unsplash.jpg')} /><img src={asset('/images/electrician-consumer-unit.jpg')} alt="" /></picture><div className="home-hero-inner"><p className="eyebrow eyebrow--orange">JD Electrical · Northern Ireland</p><h1>Power, precisely delivered.</h1><p>Dependable domestic and commercial electrical work, planned carefully and completed with pride.</p><div className="hero-actions"><LinkButton href="/contact">Send an enquiry</LinkButton><LinkButton href="/projects" variant="text">View demo projects</LinkButton></div></div></section>
